  ...
  return (
    <div className="w-full h-max pb-4  dark:bg-slate-500 dark:bg-opacity-[0.20] border border-[#00000028] dark:border-[#ffffff1d] backdrop-blur shadow-[bg-slate-700] rounded-lg p-3 shadow-inner">
      <div className="flex w-full">
        ...
        />
        <div className="justify-between hidden w-full 800px:flex">
          <div className="pl-4">
         ...
         {/* for mobile */}
         <div className="flex flex-col justify-between w-full 800px:hidden">
          <div className="pl-4">
            <h5 className="text-[20px] text-black dark:text-white">
              {props.item.name}
            </h5>
      ...
      <p
        className="px-2 pt-2 text-black font-Poppins dark:text-white "
      >
        {props.item.comment}
      </p>
    </div>
