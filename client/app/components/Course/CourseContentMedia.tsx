              ...
              <>
                <div className="flex w-full">
                  ...
                  <div className="w-full">
                    ...
                    <div className="flex w-full pb-3 ml-2">
                      {[1, 2, 3, 4, 5].map((i) =>
                        rating >= i ? (
                          <AiFillStar
                            key={i}
            ...
            <div className="w-full">
              {(course?.reviews && [...course.reviews].reverse())?.map(
                (item: any, index: number) => {
                  ...
                  return (
                    <div className="w-full my-5 text-black dark:text-white" key={index}>
                      <div className="flex w-full">
                        <div>
                          <Image
                            src={
                      ...
                      {item.commentReplies.map((i: any, index: number) => (
                        <div className="flex w-full my-5 800px:ml-16" key={index}>
        ...
        {replyActive && questionId === item._id &&  (
          <>
            {item.questionReplies.map((item: any) => (
              <div className="flex w-full my-5 text-black 800px:ml-16 dark:text-white" key={item._id}>
                <div>
                  <Image
                    src={
                      item.user.avatar
