          ...
          <div className="w-full h-[80px] flex items-center justify-between p-3">
            ...
            <div className="flex items-center">
              ...
              <div className="hidden text-black cursor-pointer 800px:block dark:text-white">
                ...
                <HiOutlineUserCircle
                  size={25}
                  className="hidden text-black cursor-pointer 800px:block dark:text-white"
          ...
          >
            <div className="w-[70%] fixed z-[999999999] h-screen bg-white dark:bg-slate-900 dark:bg-opacity-90 top-0 right-0">
              ...
              // </div>
                ...
                <HiOutlineUserCircle
                  size={25}
                  className="mx-5 text-black cursor-pointer 800px:block dark:text-white"
                  onClick={() => {setOpen(true);setOpenSidebar(false)}}
                />
               )} 
              <br />
              <br />
